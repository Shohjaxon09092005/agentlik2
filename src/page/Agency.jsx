...
import rasm1 from '../image/agencyImg1.jpg'
import rasm2 from '../image/agencyImg2.jpg'
            ...
            <div className="container">
                <div className={`home_container ${isVisible ? "menu-visible" : ""}`}>
                    ...
                    <div className="divAgency">
                        ...
                        <h2 style={{ color: '#003366' }}>AGENTLIK TUZILMASI</h2>
                        <img className='agencyImg' src={rasm1} alt="" />
                        <img className='agencyImg' src={rasm2} alt="" />
