                    ...
                    <div className="container">
                        ...
                        <div className={`home_container ${isVisible ? "menu-visible" : ""}`}>
                            ...
                            <div style={{ lineHeight: '1.6' }}>
                                <h2 className='text_table_content' style={{ color: '#003366', fontSize: "24px" }}>Ishonch telefoni reglamenti</h2>
                                <div className="jamoat_container">
                                    <p> Ishonch telefoni reglamenti <a style={{color:"blue"}} href="https://api-portal.gov.uz/uploads/e5537597-5ef1-3c9d-4343-e08303641bcb_media_.pdf" target="_blank" rel="noopener noreferrer">pdf</a>.</p>
